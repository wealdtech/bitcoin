...
public class Script implements Comparable<Script>
{
     ...
     * @throws DataError
     */
    public Script(byte[] programBytes, int offset, int length) throws DataError {
...
//    }
    ...
    private static void executeScript(Transaction txContainingThis, long index,
                                      Script script, LinkedList<byte[]> stack) throws DataError {
        int opCount = 0;
    ...
    public void correctlySpends(Transaction txContainingThis, long scriptSigIndex, Script scriptPubKey,
        ...
        if (enforceP2SH && scriptPubKey.isPayToScriptHash()) {
            ...
            Script scriptPubKeyP2SH = new Script(scriptPubKeyBytes, 0, scriptPubKeyBytes.length);
